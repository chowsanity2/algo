...
public class SortByBits {
    ...
    public static int[] sortByBits(int[] arr) {
        ...
        ArrayList<Integer> raw = map.entrySet().stream().sorted(Comparator.comparingInt(Map.Entry::getKey)).map(Map.Entry::getValue).collect(ArrayList::new, ArrayList::addAll, ArrayList::addAll);
